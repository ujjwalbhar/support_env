    ...
    try:
        ...
        for step in range(1, MAX_STEPS + 1):
            ...
            try:
                ...
                rewards.append(0.0)
                steps_taken = step
                log_step(step, "null", 0.0, False, error)
                break
...
def main():
    ...
    print(f"[INFO] easy={scores.get('easy',0):.2f} medium={scores.get('medium',0):.2f} hard={scores.get('hard',0):.2f} overall={overall:.2f}", flush=True)
